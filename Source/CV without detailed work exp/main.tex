  ...
  \resumeSubHeadingListStart
    ...
    \resumeSubheading
      ...
      {Supervisors: \href{https://cse.buet.ac.bd/faculty_list/detail/sadia}{\textcolor{blue}{Dr. Sadia Sharmin}} (BUET) }{}
       \resumeItemListStart
       \resumeItem{Developed a method of detecting fake news using interaction data on Facebook.}
       \resumeItem{Our goal was to propose a more efficient solution to determine news authenticity than existing content-based or NLP-based solutions.}
